...
const Console = ({ language, cvStructure }) => {
  ...
  const translations = {
    fr: {
      ...
      terminal: "Terminal",
      welcomeMessage: "Bienvenue ! Je suis {name}, enfin une version artificielle de moi-même (propulsé par Mixtral 8x22B). Posez moi des questions sur moi je serait ravi de répondre ! (/!\\ /!\\ Mistral est suceptible d'inventer certaines inforamtions ponctuellement, vous pouvez toujours me contacter ou explorer mon portfolio ! /!\\ /!\\) tapez 'exit' pour quitter)",
    ...
    en: {
      ...
      terminal: "Terminal",
      welcomeMessage: "Welcome! I'm {name}, well actually I am a virtual version of myself (powered by Mixtral 8x22B). Ask me questions about me and I'll be happy to answer! (/!\\ /!\\ Mistral is prone to inventing certain information occasionally, you can always contact me or explore my portfolio ! /!\\ /!\\) type 'exit' to quit)",
